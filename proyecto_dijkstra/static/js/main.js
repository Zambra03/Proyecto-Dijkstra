...
var canvas = document.getElementById("visualizacion");
...
$(document).ready(function () {
  ...
  $("#btnCreateVertice").click(function () {
    clearForms(); // Limpia los formularios previos.
    $(".formVertices").slideDown(300); //Despliega el formulario para crear un vértice.
